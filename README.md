...
O usuário informa uma hipótese mínima justificada de liga de ouro sem pedras, teor, preço de venda estimado do ouro fino, custos e tarifa. O app calcula o teto de lance para ROI de 15% **sem incluir refino ou desconto da refinadora**. A tela informa que o resultado é **condicional à hipótese**, sem recomendação automática de compra. Sem limite inferior de metal defensável, o histórico de preços sozinho não permite um lance seguro. A tarifa de 6% vem **apenas do exemplo de 2018**; confirme a regra do leilão atual antes de usar outro lote. O resultado pré-lance é uma simulação da negociação, não o lucro apurado após refino.

Após receber um lote, informe **o peso medido da liga sem pedras** e **o teor testado ou confirmado** no cartão "Depois de receber o lote". O botão leva esses valores, o preço de venda editável e os custos à análise com refino, incluindo a tarifa calculada nos outros custos. A hipótese mínima usada antes do lance nunca é copiada como se fosse uma medição. Kitco, desconto e taxa percentual de refino são informados nessa segunda negociação, assim como amostra e prata conforme o resultado da separação. O app não armazena um histórico persistente de previsões e medições nesta versão.
...
Informe explicitamente o peso retirado como amostra, a prata fina estimada, o desconto contratado por grama e a **taxa percentual cobrada sobre o ouro fino**. Digitar `3` significa 3%; a taxa não tem valor fixo predefinido. Use zero somente quando tiver confirmado que o material não contém esses itens; sem esses dados, o modo não emite recomendação.

1. Ouro fino = (peso da liga de ouro sem pedras − amostra retirada) × teor / 1000.
2. Gramas de taxa do ouro = taxa percentual informada × ouro fino, arredondadas a duas casas; taxa em reais = essas gramas × (Kitco por grama − desconto informado).
...
No exemplo do documento, usando a taxa informada de 3%: 235 g, amostra de 1,1 g, teor 750, Kitco R$ 742,60/g, desconto R$ 100/g, 10 g de prata a R$ 12,68/g e venda do ouro a R$ 680/g geram R$ 3.506,88 de refino e R$ 119.292,40 de venda estimada. Se o preço de compra for R$ 100.000, o lucro estimado antes de outros custos é R$ 15.785,52. A recuperação de 98% pertence apenas ao modo simples; o modo Refino 3M supõe devolução integral do ouro calculado após a amostra e cobra o serviço separadamente.
